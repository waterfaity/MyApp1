package com.waterfairy.foldablelayout;
...
import com.waterfairy.foldablelayout.shading.FoldShading;
...
class FoldableItemLayout extends FrameLayout {
    private static final String TAG = "FoldableItemLayout";
    ...
    public void setFoldRotation(float rotation) {
        Log.i(TAG, "setFoldRotation: " + rotation);
    ...
    private static class PartView extends View {
        ...
        void setCacheBitmap(Bitmap bitmap) {
            ...
            if (bitmap != null) {
                Log.i(TAG, "setCacheBitmap: " + bitmap.getWidth() + "---" + bitmap.getHeight());
            }
        }
        ...
        @Override
        public void draw(Canvas canvas) {
            Log.i(TAG, "draw: " + gravity + "---" + bitmapBounds.bottom + "--" + localFoldRotation);
            if (shading != null) {
